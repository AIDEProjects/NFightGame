...
public class TexRole {
	...
	Vector2Int originOffset = new Vector2Int(119, 36);
	Vector2Int atkOffset = new Vector2Int(53, 60);
	...
	private Vector2 getLeftDownPos() {
		...
		//返回左下位置
		return leftDownPos.set(pos.x - flipOriginOffset.x * roleScl, pos.y - flipOriginOffset.y * roleScl);
	}
}
